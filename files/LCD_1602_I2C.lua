...
local function cursor(op)if(op==1)then send({0x00,0xe0})else send({0x00,0xc0})end return true end
local function cls()send({0x00,0x10}) return true end
local function home()send({0x00,0x20}) return true end
